...
This performs a full audit, applies safe fixes automatically, updates `WAI-Harness/spoke/advisors/tool-advisor/scan_state.json`, and writes the latest report to `WAI-Harness/spoke/advisors/tool-advisor/reports/latest.json`.
